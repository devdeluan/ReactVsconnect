                    ...
                    <form onSubmit={ cadastrarServico } className="cad_serv_formulario" action="">
                        ...
                        <div className="cad_serv_box_input">
                            ...
                            <textarea
                                name=""
                                id="descricao"
                                onChange={ (event) => { setDescricao(event.target.value) } } // pega o valor digitado e coloca como um valor
                        ...
                        <div className="cad_serv_box_input">
                            ...
                            <input
                                type="text"
                                id="proposta"
                                onChange={ (event) => { setValor(event.target.value) } } // pega o valor digitado e coloca como um valor
                                // onKeyUp={ }
                                maxLength={17}
